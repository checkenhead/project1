...
import React, { cloneElement, ReactNode, useCallback, useEffect, useMemo, useRef, useState } from 'react'
import { getClassNames, objUtil } from '@/util/function/common'
import { useResizeObserver } from '@/hooks/util/useResizeObserver'
import { SimpleLayout, SimpleLayoutProps } from '@/components/layout/simple_layout'
...
//
//   const cardSectionClassName = useMemo(() => getClassNames('card_section', props, 'className'), [className])
//   const cardSectionStyle = useMemo(() => objUtil.getNotNullish(styles), [styles])
//
//   return (
//     <div className={cardSectionClassName} style={cardSectionStyle}>
//       {children}
//     </div>
//   )
// }
